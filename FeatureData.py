...
if __name__ == '__main__':
    ...
    test_data=pd.read_csv('data/test_prc.csv')
    test_ID=test_data['ID']
    features=pd.read_csv('data/data_prc.csv')
    ...
    print('正在保存新的训练集和测试集...')
    train_data.to_csv('data/train_all_features2.csv',index=None)
    test_data.to_csv('data/test_all_features2.csv',index=None)
    print('正在保存新的训练集和测试集...')
    print('保存完毕')