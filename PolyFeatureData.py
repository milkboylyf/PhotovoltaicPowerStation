...
app_train = pd.read_csv('data/train_all_features2.csv')
print('Training data shape: ', app_train.shape)
app_test = pd.read_csv('data/test_all_features2.csv')
...
print(metric)
xgb2lgb_train = pd.read_csv('data/train_all_features2.csv')
xgb2lgb_test = pd.read_csv('data/test_all_features2.csv')
xgb2lgb_train['xgb发电量']=train_sub['发电量']
xgb2lgb_test['xgb发电量']=submission['发电量']
xgb2lgb_train.to_csv('data/xgb2lgb_train.csv',index=False)
xgb2lgb_test.to_csv('data/xgb2lgb_test.csv', index=False)
##  0.080844   0.84669334000
